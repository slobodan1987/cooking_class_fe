...
/**
 * CurrentLanguageSharedService is responsible for holding and managing the current language state of the application.
...
export class CurrentLanguageSharedService {
  constructor() {}
